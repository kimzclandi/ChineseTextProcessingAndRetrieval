...
Stack: **Python 3.12 / Ray / Parquet**. Main paths: `engine/, scripts/, tests/, configs/, data/, reports/`.
...
Existing project checks: [offline.yml](../.github/workflows/offline.yml). These remain the source of truth for the
