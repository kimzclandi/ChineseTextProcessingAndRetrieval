...
This project is now **Chinese Text Pipeline** (`chinese-text-pipeline`), previously `chinese-evidence-data-engine`.
...
```sh
git remote set-url origin https://github.com/kimzclandi/chinese-text-pipeline.git
```
