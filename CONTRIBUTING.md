...
Start with the [README](README.md) installation instructions. This repository uses Python 3.12 / Ray / Parquet.
...
The [existing CI workflow](.github/workflows/offline.yml) records the full
